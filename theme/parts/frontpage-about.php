...
if (nimbus_get_option('fp-about-toggle') == '1') { ?>
    <section id="<?php if (nimbus_get_option('fp-about-slug')=='') {echo "about";} else {echo esc_attr(nimbus_get_option('fp-about-slug'));} ?>" class="text1 frontpage-row frontpage-about <?php if(isset($parallax_active)){echo $parallax_active;} ?>" <?php if(isset($nimbus_parallax)){echo $nimbus_parallax;} ?>>   
        <div class="wrapper">
                <div class="col-md-12">
                    <?php if (nimbus_get_option('fp-about-title') != '') { ?>
                        <h1 class="about-title"><?php echo esc_html(nimbus_get_option('fp-about-title')); ?></h1>
                    <?php } ?>
                    <?php if (nimbus_get_option('fp-about-sub-title') != '') { ?>
                        <h4 class="about-sub-title h4"><?php echo esc_html(nimbus_get_option('fp-about-sub-title')); ?></h4>
                    <?php } ?>
